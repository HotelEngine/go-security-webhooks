...
// BranchProtectionRulePayload contains branch protection rule payload
type BranchProtectionRulePayload struct {
	Action string `json:"action"`
	Rule   struct {
		ID                                       int      `json:"id"`
		...
		AuthorizedActorNames                     []any    `json:"authorized_actor_names"`
	...
	Changes struct {
		...
		RequireCodeOwnerReview struct {
			From bool `json:"from"`
		} `json:"require_code_owner_review"`
